    ...
    <>
      ...
      <div>
        ...
        <input
          ...
          {change === "김성용" ? <S.Message>올바르게 입력하셨습니다.</S.Message> : 
          <S.Message style={ Message ?{color : 'red'} : {color : 'green'} }>올바르게 글을 작성해주세요.</S.Message> }
      ...
      <div>
        <h2>문제1-2. </h2>
        <button onClick={ChangeLook}>보이기</button>
        {Look &&  <p> 이 문구는 보이기 상태일 때만 볼 수 있습니다 </p>}
